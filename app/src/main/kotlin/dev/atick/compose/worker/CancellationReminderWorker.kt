...
/**
 * Worker that shows a notification when the cancellation reminder is due.
 *
 * @param context The application context.
 * @param workerParams The worker parameters.
 * @constructor Creates a new [CancellationReminderWorker] instance.
 * @see CoroutineWorker
 */
@HiltWorker
class CancellationReminderWorker
@AssistedInject
constructor(
    ...
    /**
     * Executes the work to show a notification when the cancellation reminder is due.
     *
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            val notification =
                context.cancellationReminderNotification(
    ...
    companion object {
        /**
         * Shows a notification when the cancellation reminder is due.
         *
         * @param merchantName The name of the merchant.
         * @param nextPaymentDate The next payment date.
         * @param reminderTime The time to show the notification.
         * @return The one-time work request to show the notification.
         */
