...
//    fun getCategoryAnalyses(startDate: Long, endDate: Long): Flow<List<ExpenseAnalysis>>
//    fun getAnalysisByCategory(
//        categoryType: String,
//        startDate: Long,
//        endDate: Long,
//    ): Flow<ExpenseAnalysis?>
//    fun getVendorAnalyses(startDate: Long, endDate: Long): Flow<List<VendorAnalysis>>
//    fun getAnalysisByVendor(
//        vendor: String,
//        startDate: Long,
//        endDate: Long,
//    ): Flow<VendorAnalysis?>
